              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    RowWithIcon(icon: Icons.add_alert_sharp, text: "Узнать о снижении цены", color: Colors.blueAccent, onTap: () {print("Нажатие");},),
                    SizedBox(
                      height: spaceBetween,
                    ),
                    ...
                    RowWithIcon(icon: Icons.monetization_on_rounded, text: "Бонусные баллы за покупку", color: Colors.purple),
                    Divider(
                    ...
                    RowWithIcon(icon: Icons.directions_car_filled, text: "Доставка в г.Минск 19 марта с 18:00 до 23:00. Стоимость: БЕСПЛАТНО", color: Colors.black45),
                    SizedBox(
                      height: 5.0,
                    ),
                    RowWithIcon(icon: Icons.local_shipping, text: "Доставка в пункт самовывоза (г.Минск) 19 марта", color: Colors.black45),
                    SizedBox(
                      height: spaceBetween,
                    ),
